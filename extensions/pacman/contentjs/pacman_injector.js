/*
  This injector loads scripts one by one, so we are sure that the next will be loaded after the first is loaded
*/
var scriptsForLoading = ['libs/eventemitter2.min.js', 'libs/roslib.min.js', 'contentjs/pacman.js'];
...
//injectScript('contentjs/pacman.js');
