					...
					if (missing === 0 && func) {
						...
						if (global) {
							...
							if (typeof(window.define) === "function" && window.define.amd){ //AMD
								window.define((window.GreenSockAMDPath ? window.GreenSockAMDPath + "/" : "") + ns.split(".").join("/"), [], function() { return cl; });
							} else if (typeof(window.module) !== "undefined" && window.module.exports){ //node
								window.module.exports = cl;
							}
						}
